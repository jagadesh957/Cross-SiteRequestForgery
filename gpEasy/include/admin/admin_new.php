...
class admin_new{
	...
	function NewPageForm(){
		...
		echo '<tr>';
			...
			echo '<td>';
			echo '<input type="text" class="text" name="title" maxlength="80" value="'.gpFiles::CleanTitle($_POST['title']).'" />';
			echo '</td>';
			echo '</tr>';
		...
		echo '<tr>';
			echo '<td></td>';
			echo '<td>';
			echo '<input type="hidden" class="submit" name="cmd" value="continue_new" />';
